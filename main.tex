...
\fancyfoot[LE, RO]{\thepage} %RO=right odd, RE=right even
% \fancyhead[RE,LO]{TEST}
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}}

\setlength{\headheight}{10pt}

\def \TITLE{MASTER THESIS}
...
\newpage
\pagenumbering{gobble} % Xóa page numbering ở cuối trang
\subfile{Chapter/0_1_Declaration_of_authorship.tex}
...
\subfile{Chapter/4_Numerical_results}
