...
Chapter 3 presents the core methodologies of this thesis, with an emphasis on model architecture design. A baseline Convolutional Neural Network (CNN) is first established as a reference, followed by the formulation of a Spiking Neural Network (SNN) within the RANC framework to leverage event-driven computation. The chapter then extends this design space by incorporating transformer-based global attention through a Spiking Vision Transformer (SNN-ViT). This unified framework enables a direct and consistent evaluation of CNN, SNN, and spiking transformer architectures.
